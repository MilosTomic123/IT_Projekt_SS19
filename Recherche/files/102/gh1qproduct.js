...
jQuery(document).ready(function(){jQuery('.rightslink').click(function(e){var winprops="location=no,toolbar=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=750,height=650";PopUp=window.open(jQuery(this).attr('href'),'Rightslink',winprops);e.preventDefault();});});
